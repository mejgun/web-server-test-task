...
main = do
  ...
  mapM_
    ...
    , "insert into users (name,lastname,token,login,password) values ('testauthoruser','testauthorlastname','8e37ca708c492c66383247ae57009531','testauthoruser',md5('authorpass'));"
    ]
