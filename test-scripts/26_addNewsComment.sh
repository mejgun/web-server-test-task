...
: news add comment
./curl.sh news/addcomment '{"news_id":1,"token":"8e37ca708c492c66383247ae57009531","text":"test_comment_text"}'

: news add comment
./curl.sh news/addcomment '{"news_id":1,"token":"b185b4ee226a682ff359b7640212c1c5","text":"test_comment_text"}'
